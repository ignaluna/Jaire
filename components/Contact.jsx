...
const Galery = () => {
    return (
        <div className="md:h-screen w-screen max-md:h-[300px] max-md:px-16 bg-[url('/assets/images/fondos/fondoartistas2.png')] bg-cover filter backdrop-blur-sm bg-no-repeat flex-center">
